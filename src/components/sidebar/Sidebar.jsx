...
export default function Sidebar() {
  ...
  const iconList = [
    {
      component: github,
      href: 'https://github.com/marcellinussam98'
    },
    {
      component: linkedin,
      href: 'https://www.linkedin.com/in/marcellinus-476174158?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BoRhF2EUsQJ%2BygJpLEZb%2FFA%3D%3D'
    },
    {
      component: twitter,
      href: 'https://twitter.com/marcellinus_marcellinus98'
    },
    {
      component: instagram,
      href: 'https://www.instagram.com/decent_marcellinus.marcellinus'
    },
    {
      component: gmail,
      href: 'mailto:marcellinussam98@gmail.com'
    }
  ];
  const item = {
