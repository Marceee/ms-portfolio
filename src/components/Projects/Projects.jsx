...
const webItem = [
  {
    ...
    image: profilee,
    color: '#0FFFFF',
    githubLink: 'https://github.com/marcellinussam98/profilee'
  },
  {
    ...
    image: frontenddev,
    color: '#E5E483',
    githubLink: 'https://github.com/marcellinussam98/frontenddev'
  },
  {
    ...
    image: jumpstart,
    color: '#D2E0FB'
    // githubLink: 'https://github.com/marcellinussam98'
  },
  {
    link: 'https://www.youtube.com/watch?v=Dlxz9RnltMA&ab_channel=marcellinusmarcellinus',
    ...
    image: monorepo,
    color: '#FEA1A1',
    githubLink: 'https://github.com/marcellinussam98/E-commerce-app'
  },
  {
    ...
    image: courseApp,
    color: '#C1A4AA',
    githubLink: 'https://github.com/marcellinussam98/Course-Selling-App'
  },
  {
    ...
    image: chatGPT,
    color: '#FFA6C9',
    githubLink: 'https://github.com/marcellinussam98/chat-gpt-clone'
  },
  {
    ...
    image: challenges,
    color: '#a9def9',
    githubLink: 'https://github.com/marcellinussam98/frontend-challenges'
  },
  {
    ...
    color: '#d5ebda',
    githubLink:
      'https://github.com/marcellinussam98?tab=repositories&q=chess&type=&language=javascript&sort=stargazers'
  },
  {
    ...
    color: '#f3e4f1',
    githubLink:
      'https://github.com/marcellinussam98?tab=repositories&q=bookheap&type=&language=javascript&sort=stargazers'
  },
  {
    ...
    color: '#EEA47F',
    githubLink:
      'https://github.com/marcellinussam98?tab=repositories&q=travel&type=&language=javascript&sort=stargazers'
  }
];

const androidAppItems = [
  {
    link: 'https://play.google.com/store/apps/details?id=com.themarcellinus.your_dictionary',
    ...
    color: '#CBD18F',
    githubLink:
      'https://github.com/marcellinussam98?tab=repositories&q=&type=&language=dart&sort=stargazers'
  },
  {
    link: 'https://play.google.com/store/apps/details?id=com.themarcellinus.superheroes',
    title: 'My Superhero',
    techStack: 'Tech Stack- Flutter',
    desc: 'My SuperHero app provides all SuperHeroes and Villians data like powerstats, full name from all the universes.',
    image: superhero,
    color: '#d0f4de',
    githubLink: 'https://github.com/marcellinussam98/super_hero_app'
  },
  {
    link: 'https://play.google.com/store/apps/details?id=com.themarcellinus.memestemplate',
